...
const Product = () => {
  ...
  const getData = async () => {
    await axios
      .get("http://localhost:5000/dashbord/showproduct")
      .then((response) => {
  ...
  const requestSearch = (searchedVal) => {
    const filteredRows = data.filter((row) => {
      return row.category.toString().toLowerCase().includes(searchedVal.toString().toLowerCase());
    });
                    ...
                    <CCardHeader>
                      <div className="row">
                        ...
                        <div className="col-md-4">
                          <CForm>
                            <CButton color="info" href="/dashboard/addproduct">
                              Add
                            </CButton>
                            <CFormInput
                              type="text"
